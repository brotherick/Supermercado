...
2.0.12 2016-09-15
-----------------
* fix debug loging message not printing server name.
...
- Apply toString('hex') to each buffer in an array when loging (Issue #48, https://github.com/nbrachet).
...
- Fixed filtering bug for loging (Issue 30, https://github.com/christkv/mongodb-core/issues/30).
...
- fixed issue with replset_state loging.
